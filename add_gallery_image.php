...
$(function(){
	$('p#add_field').click(function(){
		...
		{
		$('#addcontainer').append(
				'<p><label>Image Name' + count + ':</label>' 
				+ '<input type="text" name="image_name[]" id="image_name" value="" class="text-long" /><label style="padding-top:40px;">Select Image ' + count + '</label>  <input id="image' + count + '" name="image[]' + '" value="" type="file" /><p />' );
		}
		else
		{
                ...
                <div id="main">                	
					...
					<form action="" method="post" class="jNice" enctype="multipart/form-data" onsubmit="return checkValidation(this);">
						<fieldset>
							...
							<p><label>Image Name1:</label>
								<input type="text" name="image_name[]" id="image_name" value="" class="text-long" />						 
								 <label style="padding-top:40px;">Select Image1:</label><input type="file" name="image[]" id="image" value="" class="text-long" />
							</p>
							<p id="addcontainer"></p>
								<p id="add_field">
